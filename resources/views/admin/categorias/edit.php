...
<div class="row">
    <div class="col-md-6">
        <h4 class="titulo-pagina mb-0">
            ...
            <small>Editando categoria</small>
        </h4>
    </div>
    <div class="col-md-6">
...
<form method="post" action="/admin/categorias/update/<?php echo $categoria->id ?? '' ?>" class="mt-5">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-7">
            <textarea name="slug" class="form-control" id="slug"><?php echo htmlspecialchars($categoria->slug ?? ''); ?></textarea>
    ...
    <div class="row mt-4">
        <div class="col-sm-7 offset-3 text-center">
            <button class="btn btn-primary" type="submit"><i class="fa fa-check fa-fw"></i> Editar Categoria</button>
