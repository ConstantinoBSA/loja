...
<div class="row mt-3">
    <div class="col-md-6">
        <a class="btn btn-success" href="/admin/clientes/create"><i class="fa fa-plus fa-fw"></i> Criar Novo Cliente</a>
    </div>
    <div class="col-md-6">
        ...
        <?php else: ?>
            <?php foreach ($data['clientes'] as $cliente): ?>
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-secondary btn-sm" href="/admin/clientes/show/<?php echo $cliente['id']; ?>"><i class="fa fa-eye"></i></a>
                        <a class="btn btn-warning btn-sm" href="/admin/clientes/edit/<?php echo $cliente['id']; ?>"><i class="fa fa-pencil"></i></a>
