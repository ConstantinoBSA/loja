    ...
    <div class="col-md-6">
        <nav aria-label="breadcrumb" class="d-flex justify-content-end">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>/vendas/index">Vendas</a></li>
...
<ul class="lista-item mt-5">
    ...
    <li class="mt-3">
        <span>Ações:</span>
        <a class="btn btn-warning" href="/admin/vendas/edit/<?php echo $venda['id']; ?>"><i class="fa fa-pencil fa-fw"></i> Editar Venda</a>
