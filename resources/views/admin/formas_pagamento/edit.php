...
<div class="row">
    <div class="col-md-6">
        <h4 class="titulo-pagina mb-0">
            <span><i class="fa fa-plus fa-fw"></i> Formas de Pagamento</span>
            <small>Editando forma_pagamento</small>
        </h4>
    </div>
    <div class="col-md-6">
        <nav aria-label="breadcrumb" class="d-flex justify-content-end">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>/admin/formas_pagamento/index">Formas de Pagamento</a></li>
...
<form method="post" action="/admin/formas_pagamento/edit/<?php echo $data['id']; ?>" class="mt-5">
    ...
    <div class="row mt-4">
        <div class="col-sm-7 offset-3 text-center">
            <button class="btn btn-primary" type="submit"><i class="fa fa-check fa-fw"></i> Editar Forma de Pagamento</button>
            <span class="mx-1">|</span>
            <a class="btn btn-secondary" href="/admin/formas_pagamento/index"><i class="fa fa-arrow-left fa-fw"></i> Voltar a Listagem</a>
        </div>
    </div>
</form>
