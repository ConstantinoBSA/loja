    ...
    <div class="col-md-6">
        <nav aria-label="breadcrumb" class="d-flex justify-content-end">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/formas_pagamento/index">Formas de Pagamento</a></li>
...
<form method="post" action="/admin/formas_pagamento/update/<?php echo $data['id']; ?>" class="mt-5">
