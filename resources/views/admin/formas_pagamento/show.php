    ...
    <div class="col-md-6">
        <nav aria-label="breadcrumb" class="d-flex justify-content-end">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>/formas_pagamento/index">Formas de Pagamento</a></li>
...
<ul class="lista-item mt-5">
    ...
    <li class="mt-3">
        <span>Ações:</span>
        <a class="btn btn-warning" href="/admin/formas_pagamento/edit/<?php echo $forma_pagamento['id']; ?>"><i class="fa fa-pencil fa-fw"></i> Editar Forma de Pagamento</a>
