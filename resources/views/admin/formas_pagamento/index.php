...
<div class="row mb-2">
    <div class="col-md-6">
        <h4 class="titulo-pagina">
            <span><i class="fa fa-list fa-fw"></i> Formas de Pagamento</span>
            <small>Listagem de formas de pagamento</small>
        </h4>
    </div>
    <div class="col-md-6">
...
<table class="table table-striped table-bordered table-sm mt-4">
    ...
    <tbody>
    <?php if (empty($data['formas_pagamento'])): ?>
    <tr>
        <td colspan="5" class="text-center">Nenhum registro encontrado.</td>
    </tr>
        <?php else: ?>
            <?php foreach ($data['formas_pagamento'] as $forma_pagamento): ?>
                <tr>
                    <td class="text-center">
                        <?php if ($forma_pagamento['status'] == 'pendente'): ?>
...
<div class="row">
    <div class="col-md-4">
        Mostrando de <?php echo $start; ?> até <?php echo $end; ?> de <?php echo $totalFormaPagamentos; ?> registros
    </div>
    <div class="col-md-8">
        <?php if ($totalPages > 1): ?>
