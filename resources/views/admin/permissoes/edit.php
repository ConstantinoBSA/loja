...
<div class="row">
    <div class="col-md-6">
        <h4 class="titulo-pagina mb-0">
            <span><i class="fa fa-plus fa-fw"></i> Permissoes</span>
            <small>Editando permissao</small>
        </h4>
    </div>
    <div class="col-md-6">
        <nav aria-label="breadcrumb" class="d-flex justify-content-end">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/admin/permissoes/index">Permissoes</a></li>
...
<form method="post" action="/admin/permissoes/update/<?php echo $permissao->id ?? '' ?>" class="mt-5">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-7">
            <textarea name="slug" class="form-control" id="slug"><?php echo htmlspecialchars($permissao->slug ?? ''); ?></textarea>
    ...
    <div class="row mb-4">
        ...
        <div class="col-sm-7">
            <select name="status" class="form-select" id="status">
                ...
                <option value="1" <?php if (($permissao->status ?? '') == 1) {
                    echo 'selected';
                } ?>>Ativo</option>
                <option value="0" <?php if (($permissao->status ?? '') == 0) {
                    echo 'selected';
                } ?>>Inativo</option>
            </select>
    ...
    <div class="row mt-4">
        <div class="col-sm-7 offset-3 text-center">
            <button class="btn btn-primary" type="submit"><i class="fa fa-check fa-fw"></i> Editar Permissao</button>
