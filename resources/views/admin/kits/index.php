...
<div class="row mb-2">
    <div class="col-md-6">
        <h4 class="titulo-pagina">
            <span><i class="fa fa-list fa-fw"></i> Kits</span>
            <small>Listagem de kits</small>
        </h4>
    </div>
    <div class="col-md-6">
...
<div class="row mt-3">
    <div class="col-md-6">
        <a class="btn btn-success" href="/admin/kits/adicionar"><i class="fa fa-plus fa-fw"></i> Criar Nova Kit</a>
    </div>
    <div class="col-md-6">
        <form method="GET" action="/admin/kits/index">
...
<table class="table table-striped table-bordered table-sm mt-4">
    ...
    <tbody>
    <?php if (empty($data['kits'])): ?>
    <tr>
        <td colspan="5" class="text-center">Nenhum registro encontrado.</td>
    </tr>
        <?php else: ?>
            <?php foreach ($data['kits'] as $kit): ?>
                <tr>
                    <td class="text-center">
                        <?php if ($kit['status'] == 'pendente'): ?>
                            <span class="badge bg-danger">Pendente</span>
                        <?php else: ?>
                            <span class="badge bg-success">Concluído</span>
                        <?php endif; ?>
                    </td>
                    <td class="text-center"><?php echo $kit['id']; ?></td>
                    <td><?php echo $kit['nome']; ?></td>
                    <td><?php echo $kit['slug']; ?></td>
                    <td class="text-center">
                        <a class="btn btn-secondary btn-sm" href="/admin/kits/exibir/<?php echo $kit['id']; ?>"><i class="fa fa-eye"></i></a>
                        <a class="btn btn-warning btn-sm" href="/admin/kits/editar/<?php echo $kit['id']; ?>"><i class="fa fa-pencil"></i></a>
                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalDelete<?php echo $kit['id']; ?>"><i class="fa fa-trash"></i></button>
                    </td>
                </tr>
...
<div class="row">
    <div class="col-md-4">
        Mostrando de <?php echo $start; ?> até <?php echo $end; ?> de <?php echo $totalKits; ?> registros
    </div>
    <div class="col-md-8">
        <?php if ($totalPages > 1): ?>
