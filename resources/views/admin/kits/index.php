...
<div class="row mt-3">
    <div class="col-md-6">
        <a class="btn btn-success" href="/admin/kits/create"><i class="fa fa-plus fa-fw"></i> Criar Nova Kit</a>
    </div>
    <div class="col-md-6">
        ...
        <?php else: ?>
            <?php foreach ($data['kits'] as $kit): ?>
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-secondary btn-sm" href="/admin/kits/show/<?php echo $kit['id']; ?>"><i class="fa fa-eye"></i></a>
                        <a class="btn btn-warning btn-sm" href="/admin/kits/edit/<?php echo $kit['id']; ?>"><i class="fa fa-pencil"></i></a>
