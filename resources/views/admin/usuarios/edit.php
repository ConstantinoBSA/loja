...
<form method="post" action="/admin/usuarios/update/<?php echo $usuario->id ?? '' ?>" class="mt-5">
    ...
    <div class="row mt-4">
        <div class="col-sm-7 offset-3 text-center">
            <button class="btn btn-primary" type="submit"><i class="fa fa-check fa-fw"></i> Editar Usuario</button>
